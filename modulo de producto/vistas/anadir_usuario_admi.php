        ...
        <div class="container ">
            ...
            <form class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="date" class="form-control" id="inputAddress2" placeholder="ejemplo@gmail.com">
                </div>
                ...
                <select class="form-select" aria-label="Default select example">
                    <option selected>Tipo de administrador</option>
                    <option value="1">Administrador general</option>
                    <option value="2">Administrador de comunidad</option>
