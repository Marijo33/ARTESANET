            ...
            <div class="user-menu">
                ...
                <div class="dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <ul>
                            <li><a href="#">Nueva oferta disponible</a></li>
                            <li><a href="#">Mensaje de soporte</a></li>
                            <li><a href="#">Actualización de producto</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="dropdown cart-dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="#" class="btn-card">Ver Carrito</a>
                    </div>
                </div>
                ...
                <div class="profile-dropdown">
                    ...
                    <div class="profile-dropdown-menu">
                        ...
                        <ul class="profile-menu">
                            <li><a href="#"><i class="fas fa-shopping-bag"></i> Historial de Compras</a></li>
                            <li><a href="#"><i class="fas fa-heart"></i> Lista de Deseos</a></li>
                            <li><a href="#"><i class="fas fa-cog"></i> Configuración de Perfil</a></li>
